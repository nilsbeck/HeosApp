...
from PySimpleGUI.PySimpleGUI import MENU_RIGHT_CLICK_DISABLED, RELIEF_FLAT, T, Combo, Element, Text
...
col1 = [
    ...
    [
        sg.Table(
            values=[], 
            headings=['*', 'Name', 'Artist', 'Album'], 
            key='-SRESULT-',
            justification=LEFT, 
            size=(60, 40), 
            col_widths=[3, 20, 15, 15], 
            select_mode=sg.TABLE_SELECT_MODE_EXTENDED,
            enable_click_events=True, 
            bind_return_key=True, 
            alternating_row_color='grey28', 
            selected_row_colors=('ghostwhite', 'wheat4'),
